...
def FourierCombine(lores_hdu, hires_hdu, lores_beam_img, hires_beam_img, taper_cutoffs_deg=False, apodise=False):
    ...
    astropy.io.fits.writeto('/Users/cclark/Data/Local_Dust/hires_fourier.fits', data=hires_fourier.real, header=hires_hdr, overwrite=True)
    astropy.io.fits.writeto('/Users/cclark/Data/Local_Dust/lores_fourier.fits', data=lores_fourier.real, header=hires_hdr, overwrite=True)
    astropy.io.fits.writeto('/Users/cclark/Data/Local_Dust/comb_fourier.fits', data=comb_fourier.real, header=hires_hdr, overwrite=True)
    astropy.io.fits.writeto('/Users/cclark/Data/Local_Dust/hires_fourier_weighted.fits', data=hires_fourier_weighted.real, header=hires_hdr, overwrite=True)
    astropy.io.fits.writeto('/Users/cclark/Data/Local_Dust/lores_fourier_weighted.fits', data=lores_fourier_weighted.real, header=hires_hdr, overwrite=True)
